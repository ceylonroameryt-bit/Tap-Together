export const gameLooks:Record<string,{name:string;world:string;accent:string;bg:string;floor:string;motion:string}>={
 ...
 ttt:{name:'Hearts & Stars',world:'Starlight board',accent:'#6951c2',bg:'#d5d0f5',floor:'#a491dd',motion:'Spinning stars and bouncing hearts'},
 memory:{name:'Berry Memory',world:'Berry patisserie',accent:'#a64472',bg:'#ffe4d4',floor:'#edb593',motion:'Turning cards and dancing pairs'},
 connect:{name:'Four in Bloom',world:'Rainbow greenhouse',accent:'#407626',bg:'#e6f3c7',floor:'#9dbc73',motion:'Falling flowers and swaying stems'},
 number:{name:'Lucky Number',world:'Crystal observatory',accent:'#6d4bb0',bg:'#c9c5e9',floor:'#9987c8',motion:'Orbiting rings and a turning crystal'},
 words:{name:'Letter Shuffle',world:'Postcard clouds',accent:'#2d6ea0',bg:'#d3eaf8',floor:'#89bddb',motion:'Floating letter blocks'},
 sync:{name:'Same Wavelength',world:'Planet of us',accent:'#994b94',bg:'#ead3f2',floor:'#c49adc',motion:'Six orbiting mood planets'},
};
